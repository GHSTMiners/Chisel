...
jQuery(($) => {
        $("#confirm-delete-text").on('input', function() {
          if($("#confirm-delete-text").val().toString().toLowerCase() != "delete") {
            $("#delete-world-button").attr("disabled", "disabled");
          } else {
            $("#delete-world-button").removeAttr("disabled");
          }
        })
