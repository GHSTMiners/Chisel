                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('rock-spawns.update', $rockSpawn->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="spawn_rate" inputmode="decimal" placeholder="100.0" type="number" step=0.1 class="form-control @error('spawn_rate') is-invalid @enderror" name="spawn_rate" value="{{ old('spawn_rate') ?? $rockSpawn->spawn_rate }}" required autocomplete="name" autofocus aria-describedby="basic-addon1">
                                @error('spawn_rate')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
