...
<div class="modal fade" id="world-delete" tabindex="-1" aria-labelledby="world-delete" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Delete world: {{ $selectedWorld->name }}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p>You are about to <span  style="color:red";>DELETE</span > world: {{ $selectedWorld->name }}</p>
        <p>Type DELETE in the textbox below to confirm and press delete</p>
        <input type="text" class="form-control" id="confirm-delete-text" placeholder="Type delete here">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" id="delete-world-button" class="btn btn-danger" disabled>Delete</button>
      </div>
    </div>
  </div>
</div>
