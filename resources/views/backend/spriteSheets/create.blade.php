                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sprite-sheets.store') }}" enctype="multipart/form-data">
                            ...
                            <div class=" input-group mb-3">
                                ...
                                <input id="frame_width" step="any" type="number" class="form-control"  aria-label="frame_width">
                                @error('frame_width')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <input id="frame_height" step="any" type="number" class="form-control" aria-label="frame_height">
                                @error('frame_height')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class=" input-group mb-3">
                                ...
                                <input id="start_frame" step="any" type="number" class="form-control"  aria-label="start_frame">
                                @error('start_frame')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <input id="end_frame" step="any" type="number" class="form-control" aria-label="end_frame">
                                @error('end_frame')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
