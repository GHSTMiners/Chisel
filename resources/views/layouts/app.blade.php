...
<body>
    ...
    <div id="app">
        ...
        <div class="container">
            <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#world-picker">Change World</button>
        </div>
        </nav>
        <main class="py-4">
            @yield('content')
