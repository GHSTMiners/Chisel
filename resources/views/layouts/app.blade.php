...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.1.1/js/bootstrap.bundle.min.js" integrity="sha512-trzlduO3EdG7Q0xK4+A+rPbcolVt37ftugUSOvrHhLR5Yw5rsfWXcpB3CPuEBcRBCHpc+j18xtQ6YrtVPKCdsg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    <script src="{{ asset('js/app.js') }}" defer></script>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            ...
                            @if (Route::has('rock'))
                                <li class="nav-item">
                                    <a class="nav-link {{Route::is('rock') ? 'active' : ''}}" href="{{ route('rock') }}">{{ __('Rock') }}</a>
                                </li>
                            @endif
                            @if (Route::has('puzzle'))
                                <li class="nav-item">
                                    <a class="nav-link {{Route::is('puzzle') ? 'active' : ''}}" href="{{ route('puzzle') }}">{{ __('Puzzle') }}</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
